...
!function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            url: "Будь-ласка введіть конкретну адресу.",
            ...
            creditcard: "Будь-ласка введіть дійсний код банківської карти",
            equalTo: "Будь-ласка введіть це значення ще раз.",
            maxlength: a.validator.format("Будь-ласка введіть більше {0} симв."),
            minlength: a.validator.format("Будь -ласка введіть хоч одге значення {0} симв."),
            rangelength: a.validator.format("Введіть значення від {0} до {1} симв."),
            range: a.validator.format("Введіть значення від {0} до {1}."),
            max: a.validator.format("Будь-ласка введіть значення більше чи рівно {0}."),
            min: a.validator.format("Будь-ласка введіть значення більше чи рівно {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
