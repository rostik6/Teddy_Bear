...
$chat_id = "6735144234";
    ...
    switch ($order) {
        case 1:
            $order_text = "1 штука, ціна - 799 грн";
            break;
        case 2:
            $order_text = "2 штуки, ціна - 1520 грн";
            break;
        case 3:
            $order_text = "3 штуки, ціна- 2128 грн ";
            break;
        default:
            $order_text = "Виникла помилка замовлення, або значення не обрано";
            break;
}
